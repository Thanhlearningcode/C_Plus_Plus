 ...
 * @details Tệp này chứa các kiểu dữ liệu quan trọng cần thiết cho việc cấu hình và quản lý mô-đun SPI.
 * @version 1.0
 * @date 2024-10-01
 * @author HALA Academy
 **********************************************************/
 ...
 **********************************************************/
typedef uint16_t Spi_BaudRateType;  /**< Tốc độ Baud rate được biểu diễn dưới dạng giá trị 16-bit */
 ...
 * @details Xác định ID cho một kênh SPI, dùng để quản lý truyền và nhận dữ liệu.
 **********************************************************/
 ...
 * @details Xác định ID cho một Job SPI. Một Job có thể bao gồm nhiều kênh và thực hiện truyền/nhận dữ liệu.
 **********************************************************/
 ...
 * @details Xác định ID cho một Sequence SPI. Một Sequence có thể chứa nhiều Job để thực hiện một tác vụ lớn hơn.
 **********************************************************/
 ...
 * @details Xác định đơn vị phần cứng được sử dụng cho giao tiếp SPI trên vi điều khiển.
 **********************************************************/
 ...
 * @details Xác định trạng thái hiện tại của SPI Handler/Driver, cho biết SPI đang ở trạng thái nào (chưa khởi tạo, bận, hay nhàn rỗi).
 **********************************************************/
typedef enum {
 ...
 * @details Trạng thái hoàn thành của một Job SPI, giúp xác định Job có thành công hay không.
 **********************************************************/
typedef enum {
 ...
 * @details Trạng thái hoàn thành của một Sequence SPI, cho biết Sequence đã thực hiện xong hay chưa.
 **********************************************************/
typedef enum {
 ...
 * @details Xác định chế độ hoạt động không đồng bộ (polling hoặc interrupt) cho SPI.
 **********************************************************/
typedef enum {
